...
const Footer = async () => {
  ...
  const navLinks = [
    { href: NAV_HREFS.about, label: tHeader("nav.about") },
    { href: NAV_HREFS.certificates, label: tHeader("nav.certificates") },
    { href: NAV_HREFS.results, label: tHeader("nav.results") },
    { href: NAV_HREFS.contacts, label: tHeader("nav.contacts") },
  ]
