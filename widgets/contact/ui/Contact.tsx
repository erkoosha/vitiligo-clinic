...
import { PHONES, ADDRESS, SOCIALS, SCHEDULE } from "@/entities/clinic/model"
...
const Contact = async () => {
  ...
  const dayLabels = getScheduleDayLabels(tf)
      ...
      <div className="container mx-auto px-6 md:px-12 py-20">
        <div className="grid md:grid-cols-5 gap-12 lg:gap-20">
          ...
          <div className="md:col-span-3">
            ...
            <p className="text-gray-500 text-lg mb-10 mt-4">{t("subtitle")}</p>
